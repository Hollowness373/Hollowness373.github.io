      ...
      <div className="container about__container">
        <div className="about__me">
          <div className="about__me-image">
            <img src={ME} alt='my-toga-profile' />
          </div>
        </div>
        ...
        <motion.div ref={ref} initial="hidden" animate={inView? "visible" : "hidden"} className="about__content">
          ...
          <motion.p variants={slideInFromRight(0.8)}>Hi there! I'm Bryan Yj Actub, a skilled software developer with a passion for creating mobile applications. During my internship, I gained hands-on experience in developing mobile apps, and since then, I've successfully created several projects independently, further honing my skills and expanding my expertise.</motion.p>
          ...
          <motion.p variants={slideInFromRight(1.3)}>My goal is to continue growing as a developer and work on impactful projects that make a difference in people's lives. I am eager to bring my skills and passion to a dynamic and collaborative team, where I can continue to learn and contribute to the success of the company</motion.p>
        </motion.div>
      </div>
    </section>
  )
